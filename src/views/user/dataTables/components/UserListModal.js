            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                    ...
                    <Th justifyContent="space-between" align="center" fontSize={{ sm: '10px', lg: '12px' }} color="gray.400">Role</Th>
                </Tr>
              </Thead>
              <Tbody>
                {displayedUsers.map((user) => (
                  <Tr key={user.id}>
                    ...
                    <Td color={textColor} fontSize="sm" fontWeight="700">{user.age}</Td>
                    ...
                    <Td color={textColor} fontSize="sm" fontWeight="700">{user.role}</Td>
                  </Tr>
                ))}
              </Tbody>
            </Table>
